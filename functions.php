...
function university_files(){
    ...
    wp_enqueue_style('univain_style', get_theme_file_uri('/build/style-index.css'));
    wp_enqueue_style('university_extra_style', get_theme_file_uri('/build/index.css'));
}
    
//wp function to perform some action(type of action, fun name)
